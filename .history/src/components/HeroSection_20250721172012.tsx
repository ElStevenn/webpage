...
/* ---------- NEW: tiny type‑writer for the bash “build” command ---------- */
  ...
  useEffect(() => {
    ...
    const loop = (i: number) => {
      if (i <= full.length) {
        ...
        t = setTimeout(() => loop(i + 1), 120)
      } else {
        t = setTimeout(() => loop(0), 1400) // pause, then restart
      }
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* --- The animated bash command lives here --- */}
