    ...
    >
      ...
      >
        <motion.h1 variants={item} className="group relative text-[2.9rem] leading-[1.05] md:text-6xl font-extrabold tracking-tight">
          ...
          <span
            className="pointer-events-none absolute left-1/2 -translate-x-1/2 -bottom-3 h-[3px] w-0
                       group-hover:w-3/4 rounded-full bg-gradient-to-r from-brand-blue/0 via-brand-blue/70 to-brand-coral/0
                       transition-all duration-700"
          />
        </motion.h1>

        <motion.p variants={item} className="mt-8 text-[1.05rem] md:text-xl leading-relaxed mx-auto max-w-2xl text-white/70">
        ...
        <motion.div variants={item} className="mt-9 flex flex-wrap items-center justify-center gap-4 text-[0.8rem] tracking-wide font-medium text-white/55">
          ...
          <span className="font-mono text-[0.75rem] text-white/40 flex items-center gap-1">
            <span className="text-brand-blue/70">$</span> <TypeCommand />
          </span>
        </motion.div>
      </motion.div>
      ...
      >
        ...
        <span className="mt-1 text-[0.55rem] tracking-wider font-semibold opacity-0 group-hover:opacity-70 transition">
          ABOUT
        </span>
      </motion.button>
