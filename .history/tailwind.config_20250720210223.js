...
module.exports = {
  darkMode: 'class', // por si luego añades modo claro
  content: [
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        // (añadirás fuente real luego importando en layout si quieres)
  ...
  plugins: [
    // Agrega plugins si los instalas: forms, typography, etc.
